...
const CheckoutForm = ({ order }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (paymentIntent.status === "succeeded") {
      ...
      fetch(`${process.env.REACT_APP_SERVER}/orders-paid/${order._id}`, {
        method: "PATCH",
        headers: {
          "content-type": "application/json",
        },
        ...
        .then((data) => {
          ...
          fetch(
            `${process.env.REACT_APP_SERVER}/orders-paid-dup/${order?.pId}`,
            {
              method: "DELETE",
            }
          )
            ...
            .then((data) => {
              ...
              fetch(
                `${process.env.REACT_APP_SERVER}/products-paid/${order.pId}`,
                {
                  method: "PATCH",
                }
              )
                ...
                .then((data) => {
                  ...
                  if (data.modifiedCount >= 1) {
                    fetch(
                      `${process.env.REACT_APP_SERVER}/delete-advertisement/${order.pId}`,
                      {
                        method: "DELETE",
                      }
                    )
